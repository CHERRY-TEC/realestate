...
const pool = new Pool({
  connectionString: process.env.DATABASE_URL || "postgresql://neondb_owner:npg_S6AQBl1xjgVn@ep-noisy-bonus-axh88gf9-pooler.c-4.us-east-2.aws.neon.tech/neondb?sslmode=require",
...
async function initDB() {
  ...
  try {
    ...
    if (parseInt(propCount.rows[0].count) === 0) {
      await client.query(`INSERT INTO properties (id, name, type, location, size, price, status, feat1, feat2, feat3, image, desc) VALUES
